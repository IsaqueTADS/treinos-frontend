 ...
 */
export type chatWithAIPersonalTrainerResponse200 = {
  data: void;
  status: 200;
};

export type chatWithAIPersonalTrainerResponseSuccess =
  chatWithAIPersonalTrainerResponse200 & {
    headers: Headers;
  };
export type chatWithAIPersonalTrainerResponse =
  chatWithAIPersonalTrainerResponseSuccess;

export const getChatWithAIPersonalTrainerUrl = () => {
  return `/ai/`;
};

export const chatWithAIPersonalTrainer = async (
  options?: RequestInit,
): Promise<chatWithAIPersonalTrainerResponse> => {
  return customFetch<chatWithAIPersonalTrainerResponse>(
    getChatWithAIPersonalTrainerUrl(),
    {
      ...options,
      method: "POST",
    },
